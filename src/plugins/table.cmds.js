...
;
(function () {
    var UT = JT.JTable,utils=JT.utils,
    ...
    JT.commands['inserttable'] = {
        ...
        execCommand: function (cmd, opt) {
            ...
            opt = utils.extend({},{
                numCols: opt.numCols?opt.numCols:this.options.defaultCols,
                numRows: opt.numRows?opt.numRows:this.options.defaultRows,
                tdvalign: opt.tdvalign?opt.tdvalign:this.options.tdvalign,
                tableWidth:opt.tableWidth?opt.tableWidth:this.options.tableWidth
            });
            var me = this;
    ...
    JT.commands['insertparagraphbeforetable'] = {
        queryCommandState: function () {
    ...
    JT.commands["adaptbytext"] =
        JT.commands["adaptbywindow"] = {
            queryCommandState: function () {
    ...
    //平均分配各列
    JT.commands['averagedistributecol'] = {
        queryCommandState: function () {
            var ut = getUETableBySelected(this);
            if (!ut) return -1;
    ...
    //平均分配各行
    JT.commands['averagedistributerow'] = {
        queryCommandState: function () {
            var ut = getUETableBySelected(this);
            if (!ut) return -1;
    ...
    JT.commands["settablebackground"] = {
        queryCommandState: function () {
    ...
    JT.commands["cleartablebackground"] = {
        queryCommandState: function () {
    ...
    JT.commands["interlacetable"] = JT.commands["uninterlacetable"] = {
        queryCommandState: function (cmd) {
            var table = getTableItemsByRange(this).table;
            if (!table) return -1;
