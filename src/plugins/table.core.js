 ...
 */
(function () {
    var JTable = JT.JTable = function (table) {
        this.table = table;
        this.indexTable = [];
        this.selectedTds = [];
        this.cellsRange = {};
    ...
    //===以下为静态工具方法===
    JTable.removeSelectedClass = function (cells) {
        utils.each(cells, function (cell) {
            domUtils.removeClasses(cell, "selectTdClass");
        })
    };
    JTable.addSelectedClass = function (cells) {
        utils.each(cells, function (cell) {
            domUtils.addClass(cell, "selectTdClass");
        })
    };
    JTable.isEmptyBlock = function (node) {
     ...
     */
    JTable.getTableCellAlignState = function ( cells ) {
     ...
     * @return {Object}
     */
    JTable.getTableItemsByRange = function (editor) {
    ...
    JTable.getJTableBySelected = function (editor) {
        var table = JTable.getTableItemsByRange(editor).table;
    ...
    JTable.getDefaultValue = function (editor, table) {
        var borderMap = {
                thin:'0px',
                medium:'1px',
                thick:'2px'
    ...
    JTable.cloneCell = function(cell,ignoreMerge,keepPro){
    ...
    JTable.prototype = {
        ...
        clearSelected:function () {
            JTable.removeSelectedClass(this.selectedTds);
            this.selectedTds = [];
            this.cellsRange = {};
        },
        /**
        ...
        moveContent:function (cellTo, cellFrom) {
            if (JTable.isEmptyBlock(cellFrom)) return;
            if (JTable.isEmptyBlock(cellTo)) {
        ...
        updateWidth:function (width, defaultValue) {
            var table = this.table,
                tmpWidth = JTable.getWidth(table) - defaultValue.tdPadding * 2 - defaultValue.tdBorder + width;
